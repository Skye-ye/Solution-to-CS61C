...
int add_matrix(matrix *result, matrix *mat1, matrix *mat2) {
  // Task 1.5 TODO
  if (result->cols != mat1->cols || result->rows != mat1->rows ||
      result->data == NULL) {
    return -1;
  }
...
int mul_matrix(matrix *result, matrix *mat1, matrix *mat2) {
  // Task 1.6 TODO
  if (mat1->rows != result->rows || mat2->cols != result->cols ||
      mat1->cols != mat2->rows || result->data == NULL) {
    return -1;
  }
...
int pow_matrix(matrix *result, matrix *mat, int pow) {
  // Task 1.6 TODO
  if (mat->cols != mat->rows || result->rows != result->cols ||
      result->data == NULL || pow < 0) {
    return -1;
  }
  if (pow == 0) {
